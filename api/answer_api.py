...
answer_put_list_parser = reqparse.RequestParser()
answer_put_list_parser.add_argument('requester_id', type=str, required=True)
answer_put_list_parser.add_argument('task_id', type=str, required=True)
answer_put_list_parser.add_argument('worker_id', type=str, required=True)
answer_put_list_parser.add_argument('worker_source', type=str, required=True)
answer_put_list_parser.add_argument('answers', type=str, required=True)
answer_put_list_parser.add_argument('is_alive',
...
class AnswerListApi2(Resource):
    ...
    def put(self):
        ...
        :param bool is_alive: optional.
        """
        args = answer_put_list_parser.parse_args()
        ...
        for submitted_answer in submitted_answers:
            question_name, value = submitted_answer
